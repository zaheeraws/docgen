...
go build -ldflags "-X github.com/zaheeraws/docgen/cmd.GitCommit=$GIT_COMMIT -X github.com/zaheeraws/docgen/cmd.Version=$TAG -X github.com/zaheeraws/docgen/cmd.BuildDate=$DATE" -o mac_amd64 -v .
